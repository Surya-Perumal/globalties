...
<head>
    ...
    <title>Study in Spain | The Global Ties</title>
    <!-- Custom CSS -->
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="study_in_spain.css">
    <!-- Font Awesome -->
...
<section class="about-hero">
    <div class="container aos-init aos-animate" data-aos="fade-up">
      <h1>Study in<span class="accent-text" style="color:var(--accent);"> Spain</span></h1>
    ...
    <div class="layout-container intro-grid">
        ...
        <div class="intro-content">
            <span class="gold-label">Staying in Spain permanently | the global ties</span>

            <h2 class="section-title">
           Study Abroad in 
            <span class="accent-text">Spain</span>
          </h2>
 ...
 <h2 class="section-title">
                        ...
                        <div class="opp-slider-track" id="opp-track">
                            ...
                            <div class="opp-slide">
                                <div class="opp-card luxury-card">
                                    ...
                                    <p class="card-text">If you want to make Spain your permanent home, there are a
        ...
        <section class="advantage-banner">
            <div class="layout-container advantage-grid">
                <div>
                    <h2 class="destinations-titles">Why International Students Choose Spain</h2>
                </div>
...
<section class="cost-living-section" style="padding:30px 0;background-color:#f8f9fa;">
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">
                Part-Time Jobs & <span class="accent-text">Work Opportunities</span> in Spain
            </h2>
        </div>
            ...
            <div class="layout-container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5" data-aos="fade-left">
                        <div class="position-relative">
                            <img src="img/img-for.jpg" alt="Students in Spain" class="img-fluid rounded-4 shadow-lg w-100" style="object-fit: cover; height: 100%; min-height: 400px;">
                            <!-- Decorative element -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fw-bold" id="contactModalLabel" style="color: var(--primary);">Spain Student Visa (Long-Stay) Checklist</h4>
                ...
                <div class="modal-body p-4" style="line-height: 1.6; font-size: 0.95rem;">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mt-2 mb-1">You must demonstrate that you have sufficient financial resources to cover your stay in Spain. Accepted financial documents include:</p>
                        <ul class="text-muted">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">6. English or Spanish Language Proficiency</strong>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mt-2 mb-0">Recent passport-size photographs meeting Spanish visa specifications.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">9. Medical Certificate</strong>
                        <p class="text-muted mt-2 mb-0">Applicants staying for more than six months must provide a medical certificate issued by a registered medical practitioner stating that the applicant does not suffer from any disease that could have serious public health implications under the International Health Regulations.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">10. Police Clearance Certificate (PCC)</strong>
                        <p class="text-muted mt-2 mb-1">If your course duration exceeds six months: Police Clearance Certificate from your country of residence.</p>
                        <p class="text-muted mt-1 mb-0">The certificate should be recent and, where required, legalized or apostilled.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">11. Health Insurance</strong>
                        <p class="text-muted mt-2 mb-1">Provide proof of:</p>
                        <ul class="text-muted">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">12. Proof of Accommodation</strong>
