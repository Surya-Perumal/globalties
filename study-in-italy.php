...
<head>
    ...
    <title>Study in Italy | The Global Ties</title>
    <!-- Custom CSS -->
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="study_in_italy.css">
    <!-- Font Awesome -->
...
<section class="about-hero">
    <div class="container aos-init aos-animate" data-aos="fade-up">
      <h1>Study in<span class="accent-text" style="color:var(--accent);"> Italy</span></h1>
      <p>Bridging the gap between your educational dreams and global realities. We are your trusted partners in international education and career advancement.</p>
        ...
        <section class="italy-intro">
    <div class="layout-container intro-grid">
        <div class="intro-image">
            <img src="img/italy_img.webp"
                alt="Students in Italy">
        </div>

        <div class="intro-content">
            <span class="gold-label">Staying in Italy permanently | the global ties</span>

            <h2 class="section-title">
          Study Abroad in 
            <span class="accent-text">Italy</span>
          </h2>

            <p class="hero-description">
               Italy is a scenic country with high-ranked universities located in Southwestern Europe on the Apennine peninsula. Universities in Italy offer students with quality higher education and affordable tuition fees. Italy is the home to many prestigious Universities and other institutions of superior higher education.  
            <br>
         Even though the courses and programs offered are in Italian, the number of English programs available is growing.
<br>
 Universities in Italy offer enticing proposition for foreign students as the cost of studying in Italy is lower than that of other parts of Western Europe or Northern America.</p>
 ...
 <h2 class="section-title">
           Why Choose
            <span class="accent-text">Italy</span>
                    ...
                    <p class="hero-description">Explore the numerous opportunities Italy offers for international students to gain valuable work experience during their studies, build professional skills after graduation, and establish a strong foundation for a successful international career. With access to part-time work opportunities, a growing job market, and pathways to long-term residence for eligible graduates, Italy provides an excellent environment for both academic and professional growth.</p>
                        ...
                        <div class="opp-slider-track" id="opp-track">
                            ...
                            <div class="opp-slide">
                                <div class="opp-card luxury-card">
                                    ...
                                    <p class="card-text">The Post-Graduation/Diploma Work Permit Program allows you to
                                        ...
                                        Italy. This can help you apply to become a permanent resident of Italy.</p>
                                    <a href="#" class="read-more-btn" onclick="toggleCard(event, this)">Read More
                                        &rarr;</a>
                                </div>
                            </div>
                            ...
                            <div class="opp-slide">
                                <div class="opp-card luxury-card">
                                    ...
                                    <p class="card-text">If you want to make Italy your permanent home, there are a
                                        number of ways to apply. In most cases, you will not need to leave Italy.</p>
                                    <a href="#" class="read-more-btn" onclick="toggleCard(event, this)">Read More
                                        &rarr;</a>
                                </div>
                            </div>
        ...
        <!-- Section 4: Italy Advantage Banner -->
        <section class="advantage-banner">
            <div class="layout-container advantage-grid">
                <div>
                    <h2 class="destinations-titles">Why International Students Choose Italy</h2>
                </div>
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center mb-2" data-aos="fade-up">
            ...
            <p class="hero-description mx-auto" style="max-width:700px;">
                Estimated annual tuition fees for international students studying in Italy.
            </p>
        </div>
            ...
            <table class="table table-hover table-bordered shadow-sm"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            Public universities offer affordable tuition based on income and university policies.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            Fees vary depending on programme, university, and specialization.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            Business schools and executive programmes generally have higher tuition fees.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            Many doctoral programmes offer scholarships and research funding.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            Medical universities and private institutions may have higher fees.
                        </td>
                    </tr>
...
<section class="cost-living-section" style="padding:30px 0;background-color:#f8f9fa;">
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center mb-2" data-aos="fade-up">
            ...
            <p class="hero-description mx-auto" style="max-width:700px;">
                Estimated monthly living expenses for international students in major Italian cities.
            </p>
            ...
            <table class="table table-hover table-bordered shadow-sm"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            University of Milan, Bocconi University, Politecnico di Milano
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px">
                            Sapienza University of Rome, Roma Tre University
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            University of Florence, University of Naples, University of Pisa
                        </td>
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">
                Part-Time Jobs & <span class="accent-text">Work Opportunities</span> in Italy
            </h2>
        </div>
        ...
        <div class="row g-5 align-items-center mb-5">
            ...
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="text-muted" style="line-height:1.8;">
                    Italy offers international students excellent opportunities to gain valuable work experience while pursuing their studies. Eligible students can work part-time while studying, allowing them to earn additional income, develop professional skills, and experience Italy's vibrant and multicultural work environment.
                </p>

                <p class="text-muted" style="line-height:1.8;">
                    Students can find part-time employment in hospitality, tourism, retail, restaurants, customer service, administration, fashion, logistics, universities, research projects, IT support, marketing, education, and campus-based positions. These opportunities help students build practical experience while improving communication and workplace skills.
                </p>

                <p class="text-muted" style="line-height:1.8;">
                    Working while studying enables students to become financially independent, strengthen their resumes, expand professional networks, improve employability, and prepare for successful international careers.
                </p>
                ...
                <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 start-0 w-100 p-4 rounded-bottom-4"
                        ...
                        <p class="text-white opacity-75 mb-0" style="font-size:.9rem;">
                            Build a rewarding international career in Italy.
                        </p>
            ...
            <div class="col-12">
                ...
                <div class="bg-white p-5 rounded-4 shadow-sm"
                    ...
                    <p class="text-muted mb-4">
                        After completing an eligible qualification, international graduates can explore post-study employment opportunities across Italy's growing industries. Practical work experience helps graduates develop professional skills, gain valuable international exposure, and build successful long-term careers.
                    </p>

                    <p class="text-muted mb-0">
                        Italy offers excellent career opportunities across industries such as Engineering, Information Technology, Architecture, Fashion & Design, Automotive, Hospitality, Tourism, Healthcare, Manufacturing, Business Management, Finance, Food Technology, Renewable Energy, Research, and Digital Innovation.
                    </p>
                ...
                <ul class="list-unstyled mb-0" style="line-height:2;">
                    ...
                    <li class="d-flex align-items-start mb-3">
                        ...
                        <span class="text-muted fw-bold">
                            Gain valuable Italian work experience.
                        </span>
                    </li>
                    ...
                    <li class="d-flex align-items-start mb-3">
                        ...
                        <span class="text-muted fw-bold">
                            Experience Italy's vibrant and multicultural work culture.
                        </span>
                    </li>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                ...
                <div class="bg-primary text-white p-5 rounded-4 h-100 d-flex flex-column justify-content-center position-relative overflow-hidden"
                    ...
                    <p class="mb-4 position-relative z-1 text-light"
                        ...
                        The Global Ties provides complete guidance for students planning to study in Italy. Our experienced counsellors assist with university selection, admissions, document verification, student visa applications, financial documentation, accommodation guidance, pre-departure orientation, and post-arrival support. We also help students understand part-time work rights, post-study career opportunities, and long-term career planning to ensure a successful study abroad journey.
                    ...
                    <div class="p-3 rounded-3 position-relative z-1"
                        ...
                        <p class="mb-0 small" style="opacity:.85;">
                            ...
                            <strong>Note:</strong> Student work permissions, permitted working hours, and post-study employment regulations in Italy are governed by Italian immigration authorities and may change over time. Students should always verify the latest regulations before accepting employment opportunities.
            ...
            <div class="layout-container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5" data-aos="fade-left">
                        <div class="position-relative">
                            <img src="img/img-for.jpg" alt="Students in Italy" class="img-fluid rounded-4 shadow-lg w-100" style="object-fit: cover; height: 100%; min-height: 400px;">
                            <!-- Decorative element -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fw-bold" id="contactModalLabel" style="color: var(--primary);">Italy Student Visa (Type D) Checklist</h4>
                ...
                <div class="modal-body p-4" style="line-height: 1.6; font-size: 0.95rem;">
                    ...
                    <p class="text-muted mb-4">Applying for an Italy Student Visa (National Long-Stay Study Visa – Type D) requires accurate documentation and careful preparation. Missing or incomplete documents can result in processing delays or visa refusal. The Global Ties provides complete guidance to help students prepare a strong and successful student visa application.</p>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted mt-2">
                            <li>Original passport valid for at least three months beyond your intended stay in Italy.</li>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted mt-2">
                            <li>Official Letter of Admission from a recognized Italian university or higher education institution.</li>
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">3. Completed Student Visa Application</strong>
                        <ul class="text-muted mt-2">
                            <li>Completed and signed Italy National Visa (Type D) application form.</li>
                            <li>Ensure all information matches your passport and university admission letter.</li>
                        </ul>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">4. Proof of Financial Support</strong>
                        <p class="text-muted mt-2 mb-1">You must demonstrate that you have sufficient financial resources to cover your expenses while studying in Italy. Accepted financial documents include:</p>
                        <ul class="text-muted">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">6. English or Italian Language Proficiency</strong>
                        ...
                        <ul class="text-muted">
                            ...
                            <li>CILS or CELI (for Italian-taught programs)</li>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted">
                            <li>Why you chose Italy</li>
                            <li>Why you selected your university and program</li>
                            <li>Your academic background</li>
                            <li>Career goals after graduation</li>
                            <li>Your intention to comply with Italian immigration regulations</li>
                        </ul>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">8. Passport-Size Photographs</strong>
                        <p class="text-muted mt-2 mb-0">Recent passport-size photographs meeting Italian visa specifications.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">9. Health Insurance</strong>
                        <p class="text-muted mt-2 mb-0">Provide proof of: Valid health insurance covering medical expenses in Italy for the initial period of your stay, as required by the Italian authorities.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">10. Proof of Accommodation</strong>
                        <p class="text-muted mt-2 mb-1">Provide one of the following:</p>
                        <ul class="text-muted">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">11. Tuition Fee Payment Proof</strong>
                        <p class="text-muted mt-2 mb-0">If applicable, provide: Receipt or confirmation showing payment of tuition fees or the required deposit.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">12. Flight Reservation (If Requested)</strong>
                        <p class="text-muted mt-2 mb-0">Tentative flight itinerary or reservation, if required by the Italian Embassy or Visa Application Centre.</p>
                    </div>
