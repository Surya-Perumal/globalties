...
<head>
    ...
    <title>Study in Sweden | The Global Ties</title>
    <!-- Custom CSS -->
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="study_in_sweden.css">
    <!-- Font Awesome -->
...
<section class="about-hero">
    <div class="container aos-init aos-animate" data-aos="fade-up">
      <h1>Study in<span class="accent-text" style="color:var(--accent);"> Sweden</span></h1>
      <p>Bridging the gap between your educational dreams and global realities. We are your trusted partners in international education and career advancement.</p>
        ...
        <section class="sweden-intro">
    <div class="layout-container intro-grid">
        <div class="intro-image">
            <img src="img/swedan_img.webp"
                alt="Students in Sweden">
        </div>

        <div class="intro-content">
            <span class="gold-label">Staying in Sweden permanently | the global ties</span>

            <h2 class="section-title">
         Study Abroad in 
            <span class="accent-text">Sweden</span>
          </h2>

            <p class="hero-description">
             
It is a major decision to study abroad, particularly when there are limitless options for students to choose from. So are you trying to figure out what makes Sweden stand out as the best academic destination? Don’t just choose a place, choose your life. When you can answer the question why you would want to pick an international country, you are half way into choosing the best academic destination; therefore, check out what Sweden has in store for you and for your future:
<br>
Sweden is one of the world’s most research-intensive and innovative countries.<br>
Students can opt for scholarship to pursue their education.   </p>
 ...
 <h2 class="section-title">
           Why Choose
            <span class="accent-text">Sweden</span>
                    ...
                    <p class="hero-description">Explore the numerous opportunities Sweden offers for international students to gain valuable work experience while studying, build professional skills after graduation, and establish a strong foundation for long-term career growth. With a thriving innovation-driven economy, excellent post-study employment prospects, and pathways toward long-term residence for eligible graduates, Sweden is an ideal destination for students seeking a successful international career.</p>
                        ...
                        <div class="opp-slider-track" id="opp-track">
                            ...
                            <div class="opp-slide">
                                <div class="opp-card luxury-card">
                                    ...
                                    <p class="card-text">The Post-Graduation/Diploma Work Permit Program allows you to
                                        ...
                                        Sweden. This can help you apply to become a permanent resident of Sweden.</p>
                                    <a href="#" class="read-more-btn" onclick="toggleCard(event, this)">Read More
                                        &rarr;</a>
                                </div>
                            </div>
                            ...
                            <div class="opp-slide">
                                <div class="opp-card luxury-card">
                                    ...
                                    <p class="card-text">If you want to make Sweden your permanent home, there are a
                                        number of ways to apply. In most cases, you will not need to leave Sweden.</p>
                                    <a href="#" class="read-more-btn" onclick="toggleCard(event, this)">Read More
                                        &rarr;</a>
                                </div>
                            </div>
        ...
        <!-- Section 4: Sweden Advantage Banner -->
        <section class="advantage-banner">
            <div class="layout-container advantage-grid">
                <div>
                    <h2 class="destinations-titles">Why International Students Choose Sweden</h2>
                </div>
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center mb-2" data-aos="fade-up">
            ...
            <p class="hero-description mx-auto" style="max-width:700px;">
                Estimated annual tuition fees for international students studying in Sweden.
            </p>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            SEK 80,000 – SEK 150,000 / year
                        </td>

                        <td style="padding:15px;">
                            Tuition fees vary depending on university and programme specialization.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            SEK 90,000 – SEK 200,000 / year
                        </td>

                        <td style="padding:15px;">
                            Popular programmes include Engineering, IT, Business, and Data Science.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            Many PhD positions are funded and offered as employment opportunities.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            SEK 120,000 – SEK 250,000 / year
                        </td>

                        <td style="padding:15px;">
                            Advanced technical and professional programmes may have higher tuition fees.
                        </td>
                    </tr>
...
<section class="cost-living-section" style="padding:30px 0;background-color:#f8f9fa;">
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center mb-2" data-aos="fade-up">
            ...
            <p class="hero-description mx-auto" style="max-width:700px;">
                Estimated monthly living expenses for international students in major Swedish cities.
            </p>
            ...
            <table class="table table-hover table-bordered shadow-sm"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:15px;">
                            SEK 7,500 - SEK 10,500 / month
                        </td>

                        <td style="padding:15px;">
                            Malmö University, Linköping University
                        </td>
...
<section class="work-opportunities-section" style="padding: 27px 0 0px 0; background-color: #f8f9fa;">
    <div class="layout-container">
        ...
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">
                Part-Time Jobs & <span class="accent-text">Work Opportunities</span> in Sweden
            </h2>
        </div>
        ...
        <div class="row g-5 align-items-center mb-5">
            ...
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="text-muted" style="line-height:1.8;">
                    Sweden offers international students excellent opportunities to gain valuable work experience while pursuing their studies. Eligible students can work part-time while studying, helping them earn additional income, develop professional skills, and gain exposure to Sweden's innovative and collaborative workplace culture.
                </p>

                <p class="text-muted" style="line-height:1.8;">
                    Students can find part-time employment in retail, hospitality, restaurants, customer service, supermarkets, logistics, administration, universities, research projects, IT support, digital services, healthcare assistance, education, and campus-based positions. These opportunities help students gain practical experience while strengthening communication and workplace skills.
                </p>

                <p class="text-muted" style="line-height:1.8;">
                    Working while studying enables students to become financially independent, build professional networks, enhance their resumes, improve employability, and prepare for successful international careers.
                </p>
                ...
                <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 start-0 w-100 p-4 rounded-bottom-4"
                        ...
                        <p class="text-white opacity-75 mb-0" style="font-size:.9rem;">
                            Build a successful international career in Sweden.
                        </p>
            ...
            <div class="col-12">
                ...
                <div class="bg-white p-5 rounded-4 shadow-sm"
                    ...
                    <p class="text-muted mb-4">
                        After completing an eligible qualification, international graduates can explore excellent post-study employment opportunities in Sweden. The country's innovation-driven economy, world-leading companies, and strong demand for skilled professionals provide graduates with valuable international work experience and long-term career growth.
                    </p>

                    <p class="text-muted mb-0">
                        Sweden offers outstanding career opportunities across industries such as Information Technology, Artificial Intelligence, Engineering, Healthcare, Biotechnology, Renewable Energy, Manufacturing, Automotive, Telecommunications, Business Management, Finance, Environmental Science, and Digital Innovation.
                    </p>
                ...
                <ul class="list-unstyled mb-0" style="line-height:2;">
                    ...
                    <li class="d-flex align-items-start mb-3">
                        ...
                        <span class="text-muted fw-bold">
                            Gain valuable Swedish work experience.
                        </span>
                    </li>
                    ...
                    <li class="d-flex align-items-start mb-3">
                        ...
                        <span class="text-muted fw-bold">
                            Experience Sweden's innovative and inclusive work culture.
                        </span>
                    </li>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                ...
                <div class="bg-primary text-white p-5 rounded-4 h-100 d-flex flex-column justify-content-center position-relative overflow-hidden"
                    ...
                    <p class="mb-4 position-relative z-1 text-light"
                        ...
                        The Global Ties provides complete guidance for students planning to study in Sweden. Our experienced counsellors assist with university selection, admissions, document verification, residence permit applications, financial documentation, accommodation guidance, pre-departure orientation, and post-arrival support. We also help students understand part-time work rights, post-study career opportunities, and long-term career planning to ensure a successful study abroad journey.
                    ...
                    <div class="p-3 rounded-3 position-relative z-1"
                        ...
                        <p class="mb-0 small" style="opacity:.85;">
                            ...
                            <strong>Note:</strong> Student work permissions, residence permit conditions, and post-study employment regulations in Sweden are governed by Swedish immigration authorities and may change over time. Students should always verify the latest regulations before accepting employment opportunities.
        ...
        <section class="why-choose-us-section" style="padding: 30px 0; background-color: #f8f9fa;">
            <div class="layout-container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5" data-aos="fade-left">
                        <div class="position-relative">
                            <img src="img/img-for.jpg" alt="Students in Sweden" class="img-fluid rounded-4 shadow-lg w-100" style="object-fit: cover; height: 100%; min-height: 400px;">
                            <!-- Decorative element -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fw-bold" id="contactModalLabel" style="color: var(--primary);">Sweden Student Visa (Residence Permit) Checklist</h4>
                ...
                <div class="modal-body p-4" style="line-height: 1.6; font-size: 0.95rem;">
                    ...
                    <p class="text-muted mb-4">Applying for a Sweden Student Residence Permit requires accurate documentation and careful preparation. Missing or incomplete documents can result in processing delays or refusal. The Global Ties provides complete guidance to help students prepare a strong and successful residence permit application.</p>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted mt-2">
                            ...
                            <li>Copies of all used pages and personal information page.</li>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted mt-2">
                            <li>Official Letter of Admission from a recognized Swedish university or higher education institution.</li>
                            <li>The admission letter should include: Course name, Duration of study, Start and end dates, Full-time study confirmation.</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted mt-2">
                            <li>Complete the online Residence Permit application through the Swedish Migration Agency.</li>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mt-2 mb-1">You must demonstrate sufficient financial resources to support yourself during your stay in Sweden. Accepted financial documents include:</p>
                        <ul class="text-muted">
                            <li>Recent bank statements</li>
                            <li>Education loan sanction letter</li>
                            <li>Scholarship award letter</li>
                            <li>Sponsorship letter (where applicable)</li>
                            <li>Sponsor's income documents</li>
                            <li>Tuition fee payment receipt</li>
                            <li>Proof of funds meeting Swedish Migration Agency requirements</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mt-2 mb-1">If required by your institution, provide:</p>
                        <ul class="text-muted">
                            <li>IELTS Academic</li>
                            <li>PTE Academic</li>
                            <li>TOEFL iBT</li>
                            <li>Cambridge English Qualifications</li>
                            <li>Other accepted English language test scores</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted">
                            <li>Why you chose Sweden</li>
                            <li>Why you selected your university and program</li>
                            <li>Your academic background</li>
                            <li>Career goals after graduation</li>
                            <li>Your intention to comply with Swedish immigration regulations</li>
                        </ul>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">8. Passport-Size Photograph</strong>
                        <p class="text-muted mt-2 mb-0">Recent passport-size photograph meeting Swedish residence permit specifications (if required).</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">9. Health Insurance</strong>
                        <p class="text-muted mt-2 mb-1">If your course duration is less than one year: Proof of comprehensive health insurance valid throughout your stay.</p>
                        <p class="text-muted mt-1 mb-0">For studies of one year or more: Students are generally covered under Sweden's healthcare system after registration, subject to applicable rules.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">10. Tuition Fee Payment Proof</strong>
                        <p class="text-muted mt-2 mb-0">If applicable, provide: Receipt or confirmation showing payment of tuition fees or the first installment, as required by your university.</p>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">11. Proof of Accommodation (Recommended)</strong>
                        <p class="text-muted mt-2 mb-1">Provide one of the following, if available:</p>
                        <ul class="text-muted">
                            <li>University accommodation confirmation</li>
                            <li>Rental agreement</li>
                            <li>Student housing booking</li>
                            <li>Temporary accommodation reservation</li>
                        </ul>
                    </div>
