...
<body>
  ...
  <section class="mbbs-hero">
    <div class="container" data-aos="fade-up">
      <h1>Study MBBS in <span class="accent-text" style="color:var(--accent);">Russia</span></h1>
  ...
  <section class="content-section">
    <div class="container">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title">Why Study MBBS in <span class="accent-text">Russia?</span></h2>
        <p class="text-muted mt-3">Russia is one of the most preferred destinations for MBBS due to its globally recognized 
universities, affordable tuition fees, and high-quality medical education. Russian medical 
universities are approved by international organizations such as WHO and NMC, enabling 
graduates to pursue careers worldwide. Students benefit from modern infrastructure, 
experienced faculty, English-medium programs, and excellent clinical exposure.</p>
      </div>
      <div class="row g-4">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6" data-aos="fade-right">
          <h2 class="section-title">Top Medical Universities in <span class="accent-text">Russia</span></h2>
          <p class="mt-4 text-muted">These prestigious medical universities in Russia offer high-quality education and a comprehensive MBBS program which includes academic training and clinical internships.</p>
        ...
        <div class="col-lg-6 mt-5 mt-lg-0" data-aos="fade-left">
          <img src="img/russia-university.png" alt="Medical Students" class="img-fluid rounded shadow-lg" style="object-fit:cover; height:400px; width:100%;">
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="p-4 border rounded shadow-sm bg-white">
            <ul class="custom-list">
              ...
              <li><strong>Step 3:</strong> Apply for the official Invitation Letter from the Ministry of Education, Russia.</li>
              <li><strong>Step 4:</strong> Apply for the Student Visa at the Russian Embassy.</li>
