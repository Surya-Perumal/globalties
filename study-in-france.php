...
<head>
    ...
    <title>Study in France | The Global Ties</title>
    <!-- Custom CSS -->
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="study_in_france.css">
    <!-- Font Awesome -->
...
<section class="about-hero">
    <div class="container aos-init aos-animate" data-aos="fade-up">
      <h1>Study in<span class="accent-text" style="color:var(--accent);"> France</span></h1>
    ...
    <div class="layout-container intro-grid">
        ...
        <div class="intro-content">
            <span class="gold-label">Staying in France permanently | the global ties</span>

            <h2 class="section-title">
         Study Abroad in 
            <span class="accent-text">France</span>
          </h2>
 ...
 <h2 class="section-title">
                        ...
                        <div class="opp-slider-track" id="opp-track">
                            ...
                            <div class="opp-slide">
                                <div class="opp-card luxury-card">
                                    ...
                                    <p class="card-text">If you want to make France your permanent home, there are a
        ...
        <section class="advantage-banner">
            <div class="layout-container advantage-grid">
                <div>
                    <h2 class="destinations-titles">Why International Students Choose France</h2>
                </div>
...
<section class="cost-living-section" style="padding:30px 0;background-color:#f8f9fa;">
    ...
    <div class="layout-container">
        ...
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">
                Part-Time Jobs & <span class="accent-text">Work Opportunities</span> in France
            </h2>
        </div>
            ...
            <div class="layout-container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5" data-aos="fade-left">
                        <div class="position-relative">
                            <img src="img/img-for.jpg" alt="Students in France" class="img-fluid rounded-4 shadow-lg w-100" style="object-fit: cover; height: 100%; min-height: 400px;">
                            <!-- Decorative element -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fw-bold" id="contactModalLabel" style="color: var(--primary);">France Student Visa (VLS-TS) Checklist</h4>
                ...
                <div class="modal-body p-4" style="line-height: 1.6; font-size: 0.95rem;">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">3. Campus France Approval (If Applicable)</strong>
                        <ul class="text-muted mt-2">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">4. Completed Student Visa Application</strong>
                        <ul class="text-muted mt-2">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mt-2 mb-1">You must demonstrate sufficient financial resources to support your stay in France. Accepted financial documents include:</p>
                        <ul class="text-muted">
                    ...
                    <div class="mb-3">
                        <strong class="text-dark">7. English or French Language Proficiency</strong>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mt-2 mb-0">Recent passport-size photographs meeting French visa specifications.</p>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="text-muted">
                            <li>Valid health insurance covering your initial stay in France (if required).</li>
                            <li>Students will generally be required to register with the French Social Security system after arrival.</li>
                        </ul>
                    </div>

                    <div class="mb-3">
                        <strong class="text-dark">12. Flight Reservation (If Requested)</strong>
                        <p class="text-muted mt-2 mb-0">Tentative flight itinerary or reservation, if required by the visa application centre.</p>
                    </div>
