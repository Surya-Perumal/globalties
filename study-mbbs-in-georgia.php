...
<body>
  ...
  <section class="mbbs-hero">
    <div class="container" data-aos="fade-up">
      <h1>Study MBBS in <span class="accent-text" style="color:var(--accent);">Georgia</span></h1>
  ...
  <section class="content-section">
    <div class="container">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title">Why Study MBBS in <span class="accent-text">Georgia?</span></h2>
        <p class="text-muted mt-3">Georgia features WHO-approved medical degrees and clinical exposure designed in accordance with European health guidelines.</p>
      </div>
      <div class="row g-4">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6" data-aos="fade-right">
          <h2 class="section-title">Top Medical Universities in <span class="accent-text">Georgia</span></h2>
          <p class="mt-4 text-muted">These prestigious medical universities in Georgia offer high-quality education and a comprehensive MBBS program which includes academic training and clinical internships.</p>
        ...
        <div class="col-lg-6 mt-5 mt-lg-0" data-aos="fade-left">
          <img src="img/georgia.png" alt="Medical Students" class="img-fluid rounded shadow-lg" style="object-fit:cover; height:400px; width:100%;">
        </div>
      </div>
    </div>
  </section>
