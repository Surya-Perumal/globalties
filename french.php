...
<body>
  ...
  <section class="tp-hero">
    <div class="container" data-aos="fade-up">
      <h1><span class="accent-text" style="color:var(--accent);">French</span> Preparation</h1>
      ...
      <div class="row g-4 justify-content-center">
        <div class="col-md-6 col-lg-5" data-aos="fade-up" data-aos-delay="100">
          <div class="info-card text-center p-4">
            <i class="fa-solid fa-ear-listen mb-3" style="font-size: 2rem; color: var(--primary);"></i>
            <h4 class="fw-bold mb-3">Section 1: Comprehension de l'oral</h4>
            <p class="text-muted mb-0">Assesses your listening skills by answering questions based on recorded conversations, announcements, or broadcasts.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-5" data-aos="fade-up" data-aos-delay="200">
          <div class="info-card text-center p-4">
            <i class="fa-solid fa-book-open-reader mb-3" style="font-size: 2rem; color: var(--primary);"></i>
            <h4 class="fw-bold mb-3">Section 2: Comprehension des crits</h4>
            <p class="text-muted mb-0">Evaluates your ability to extract key information and understand detailed arguments from various written documents.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-5" data-aos="fade-up" data-aos-delay="300">
          <div class="info-card text-center p-4">
            <i class="fa-solid fa-pen-nib mb-3" style="font-size: 2rem; color: var(--primary);"></i>
            <h4 class="fw-bold mb-3">Section 3: Production ecrite</h4>
            <p class="text-muted mb-0">Tests your writing skills through tasks such as drafting formal letters, essays, or expressing a structured personal opinion.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-5" data-aos="fade-up" data-aos-delay="400">
          <div class="info-card text-center p-4">
            ...
            <h4 class="fw-bold mb-3">Section 4: Production orale</h4>
            <p class="text-muted mb-0">Measures your speaking ability via a guided conversation, interactive role-play, or presenting a documented argument.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="content-section">
    <div class="container">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title mb-4">French Exams <span class="accent-text">Overview</span></h2>
      </div>
            ...
            <div class="row g-4">
              <div class="col-md-6">
                <ul class="feature-list" style="font-size: 1.1rem; line-height: 1.6; margin: 0;">
                  <li style="margin-bottom: 20px; align-items: center;"><i class="fa-solid fa-check-circle" style="font-size: 1.4rem; margin-right: 15px; margin-top: 0;"></i> <div><strong>Conducted By:</strong><br><span class="text-muted">France education international & CCIP</span></div></li>
                  <li style="margin-bottom: 20px; align-items: center;"><i class="fa-solid fa-check-circle" style="font-size: 1.4rem; margin-right: 15px; margin-top: 0;"></i> <div><strong>Test Types:</strong><br><span class="text-muted">DELF, DALF, TEF, TCF</span></div></li>
                  <li style="margin-bottom: 0; align-items: center;"><i class="fa-solid fa-check-circle" style="font-size: 1.4rem; margin-right: 15px; margin-top: 0;"></i> <div><strong>Score Range:</strong><br><span class="text-muted">Aligned with CEFR Levels (A1 to C2)</span></div></li>
                </ul>
              </div>
              <div class="col-md-6">
                <ul class="feature-list" style="font-size: 1.1rem; line-height: 1.6; margin: 0;">
                  <li style="margin-bottom: 20px; align-items: center;"><i class="fa-solid fa-check-circle" style="font-size: 1.4rem; margin-right: 15px; margin-top: 0;"></i> <div><strong>Total Duration:</strong><br><span class="text-muted">Varies (1 hr 20 mins to 4 hours)</span></div></li>
                  <li style="margin-bottom: 20px; align-items: center;"><i class="fa-solid fa-check-circle" style="font-size: 1.4rem; margin-right: 15px; margin-top: 0;"></i> <div><strong>Validity:</strong><br><span class="text-muted">Lifetime (DELF/DALF) / 2 years (TEF/TCF)</span></div></li>
                  <li style="margin-bottom: 0; align-items: center;"><i class="fa-solid fa-check-circle" style="font-size: 1.4rem; margin-right: 15px; margin-top: 0;"></i> <div><strong>Fee:</strong><br><span class="text-muted">Varies by level and test type</span></div></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="py-3">Basic User</td>
                  <td class="py-3 text-muted">Can understand and use familiar everyday expressions and basic phrases.</td>
                </tr>
                <tr>
                  <td class="py-3 fw-bold text-primary">B1 / B2</td>
                  <td class="py-3">Independent User</td>
                  <td class="py-3 text-muted">Required for most university admissions in France and Canada PR (TEF/TCF).</td>
                </tr>
                <tr>
                  <td class="py-3 fw-bold text-primary">C1 / C2</td>
                  <td class="py-3">Proficient User</td>
                  <td class="py-3 text-muted">Can express ideas fluently and spontaneously. Required for specialized academic degrees.</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
          <div class="process-card text-center" data-step="01">
            ...
            <p class="text-muted mb-0">Comprehension de l'oral (Listening): Podcasts, announcements, and dialogues.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
          <div class="process-card text-center" data-step="02">
            ...
            <p class="text-muted mb-0">Comprehension des ecrits (Reading): Articles, grammar structures, and vocabulary.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
          <div class="process-card text-center" data-step="03">
            ...
            <p class="text-muted mb-0">Production ecrite (Writing): Essays, formal letters, and structured argumentation.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
          <div class="process-card text-center" data-step="04">
            ...
            <p class="text-muted mb-0">Production orale (Speaking): Role-plays, monologues, and full mock interviews.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-4 justify-content-center">
        <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
          <div class="info-card">
            ...
            <p class="text-muted">DELF/DALF are diplomas valid for life, often used for academic purposes. TEF and TCF are tests valid for 2 years, highly requested for immigration (like Canada Express Entry) or naturalization.</p>
          </div>
        </div>
        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
          <div class="info-card">
            <h4>What level is required for studying in France?</h4>
            <p class="text-muted">Most undergraduate and postgraduate programs taught in French require at least a B2 level. Highly selective programs might require C1.</p>
          </div>
        </div>
      </div>
    </div>
