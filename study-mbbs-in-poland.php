...
<body>
  ...
  <section class="mbbs-hero">
    <div class="container" data-aos="fade-up">
      <h1>Study MBBS in <span class="accent-text" style="color:var(--accent);">Poland</span></h1>
  ...
  <section class="content-section">
    <div class="container">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title">Why Study MBBS in <span class="accent-text">Poland?</span></h2>
        <p class="text-muted mt-3">Poland represents the gold standard of European medicine training, with world-class faculty and medical infrastructure.</p>
      </div>
      <div class="row g-4">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6" data-aos="fade-right">
          <h2 class="section-title">Top Medical Universities in <span class="accent-text">Poland</span></h2>
          <p class="mt-4 text-muted">These prestigious medical universities in Poland offer high-quality education and a comprehensive MBBS program which includes academic training and clinical internships.</p>
          <ul class="custom-list mt-4">
            <li>Medical University of Warsaw</li>
            <li>Jagiellonian University Medical College</li>
            <li>Medical University of Gdansk</li>
            <li>Poznan University of Medical Sciences</li>
            <li>Wroclaw Medical University</li>
          </ul>
        </div>
        <div class="col-lg-6 mt-5 mt-lg-0" data-aos="fade-left">
          <img src="img/poland.png" alt="Medical Students" class="img-fluid rounded shadow-lg" style="object-fit:cover; height:400px; width:100%;">
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="p-4 border rounded shadow-sm bg-white">
            <ul class="custom-list">
              ...
              <li><strong>Step 3:</strong> Apply for the official Invitation Letter from the Ministry of Science and Higher Education, Poland.</li>
              <li><strong>Step 4:</strong> Apply for the Student Visa at the Polish Embassy.</li>
